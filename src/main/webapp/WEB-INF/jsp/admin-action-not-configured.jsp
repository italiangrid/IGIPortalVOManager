...
<portlet:actionURL var="notConfiguredURL">
	<portlet:param name="myaction" value="notConfiguredVo" /> 
	<portlet:param name="idVo" value="<%= primKey %>" />
</portlet:actionURL>
<liferay-ui:icon image="edit" message="Set Not Configured" url="${notConfiguredURL}" />
