...
public class VOMSACLServiceLocator extends org.apache.axis.client.Service implements org.glite.security.voms.service.acl.VOMSACLService {
    ...
    public VOMSACLServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public VOMSACLServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for VOMSACL
    private java.lang.String VOMSACL_address = "https://localhost:8443/glite-security-voms-admin-interface/VOMSACL";
    ...
    private java.lang.String VOMSACLWSDDServiceName = "VOMSACL";

    public java.lang.String getVOMSACLWSDDServiceName() {
        return VOMSACLWSDDServiceName;
    }

    public void setVOMSACLWSDDServiceName(java.lang.String name) {
    ...
    public void setVOMSACLEndpointAddress(java.lang.String address) {
