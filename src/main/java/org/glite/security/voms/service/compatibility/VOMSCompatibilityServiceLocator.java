/**
 * VOMSCompatibilityServiceLocator.java
 *
...
public class VOMSCompatibilityServiceLocator extends org.apache.axis.client.Service implements org.glite.security.voms.service.compatibility.VOMSCompatibilityService {
    ...
    public VOMSCompatibilityServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public VOMSCompatibilityServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for VOMSCompatibility
    private java.lang.String VOMSCompatibility_address = "https://localhost:8443/glite-security-voms-admin-interface/VOMSCompatibility";

    public java.lang.String getVOMSCompatibilityAddress() {
        return VOMSCompatibility_address;
    }

    // The WSDD service name defaults to the port name.
    private java.lang.String VOMSCompatibilityWSDDServiceName = "VOMSCompatibility";

    public java.lang.String getVOMSCompatibilityWSDDServiceName() {
        return VOMSCompatibilityWSDDServiceName;
    }

    public void setVOMSCompatibilityWSDDServiceName(java.lang.String name) {
        VOMSCompatibilityWSDDServiceName = name;
    }

    public org.glite.security.voms.service.compatibility.VOMSCompatibility getVOMSCompatibility() throws javax.xml.rpc.ServiceException {
    ...
    public org.glite.security.voms.service.compatibility.VOMSCompatibility getVOMSCompatibility(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
    ...
    public void setVOMSCompatibilityEndpointAddress(java.lang.String address) {
